...
const socialMedia = [
  ...
  {
    name: "Linkedin",
    href: "https://www.linkedin.com/company/wwktm/",
    icon: (props: IconProps) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/wwktm/",
    icon: (props: IconProps) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@wwktm_/",
    icon: (props: IconProps) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/wwktm.co/",
    icon: (props: IconProps) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
