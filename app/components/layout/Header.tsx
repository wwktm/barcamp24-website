...
import { action as loginAction } from "../../routes/_2025.login";
...
export default function Header({ isLoggedIn }: { isLoggedIn: boolean }) {
  ...
  const actionIntent = fetcher.data?.intent;
  ...
  const getEmailButtonLinkText = useCallback(() => {
    ...
    if (fetcher.state === "submitting") return "Sending Link...";

    return "Send Link";
  }, [actionIntent, actionSuccess, fetcher.state]);
